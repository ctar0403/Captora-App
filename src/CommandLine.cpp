...
bool CommandLine::process(QCoreApplication &app)
{
    ...
    parser.setApplicationDescription(
                "Captora may be used to OCR image files or part of the screen.\n"
                "Examples:\n"
                "  Captora_CLI.exe --screen-rect \"400 200 600 300\"\n"
                "  Captora_CLI.exe --vertical -l \"Chinese - Simplified\" -i img1.png\n"
                "  Captora_CLI.exe -i img1.png -i img2.jpg -o result.txt\n"
                "  Captora_CLI.exe -l Japanese -f \"C:\\Temp\\image_files.txt\"\n"
                "  Captora_CLI.exe --show-languages");
